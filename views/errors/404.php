...
<div class="form-outer-container">
    <div style="text-align: center; max-width: 600px; margin: 0 auto; padding: 3rem 1rem;">
        <div class="card" style="padding: 3rem; background: #fff;">
            <h1 style="font-size: 4rem; margin: 0; color: #6b7280;">404</h1>
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                ...
                <a href="../../index.php?page=journal&action=list" class="btn btn-secondary">View Journal</a>
